       <!-- Sidebar -->
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <hr class="sidebar-divider">
             ...
             <!-- Nav Item - top up -->
             <li class="nav-item">
                <a class="nav-link" href="manage_pharmacy.php">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>Top Up Pharmacy</span></a>
            </li>

             <!-- Nav Item - Charts -->
             <li class="nav-item">
                <a class="nav-link" href="pharmacy_stock.php">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>Pharmacy Stock</span></a>
            </li>
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="expensis.php">
                    <i class="fas fa-fw fa-chart-area"></i>
